...
Sizes: [
	...
	<head>
		...
		<style type="text/css">
			/* RESET STYLES */
			html { background-color:#7f0093; margin:0; padding:0; }
			...
			body, #bodyTable{background-color:#7f0093;}
			#emailHeader{background-color:#7f0093;}
			...
			.emailCalendarMonth{background-color:#FFFFFF; color:#FFFFFF; font-family:Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold; padding-top:10px; padding-bottom:10px; text-align:center;}
																			...
																			<tr>
																				<td align="left" class="textContent">
																					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																						Te ha llegado un nuevo mensaje
																					</div>
																				</td>
																			</tr>
																		</table>
						...
						<table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
							...
							<tr>
								<td align="center" valign="top">
									...
									-->
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF; background: linear-gradient(rgba(2, 2, 2, 0.71), rgba(31, 29, 29, 0.94)), url(https://traya.com.ar/assets/images/bg_message.png);background-repeat: no-repeat; background-size: cover  ">
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												<!--
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<img style="width: 300px;" src="https://traya.com.ar/assets/images/logo_traya.png" alt="Traya" />
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:10px;text-align:center;">
                                            {{ $nameEmail }}
                                          </h3>
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td valign="top" bgcolor="#E1E1E1">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																			<div>Copyright &#169; {{date('Y')}} <a href="https://www.traya.com.ar/" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">Traya</span></a>. Todos &nbsp;derechos&nbsp;reservados.</div>
