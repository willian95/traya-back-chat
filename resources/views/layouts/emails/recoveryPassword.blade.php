...
<center style="background-color:#E1E1E1;">
	...
	<tr>
		...
		-->
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF; background: linear-gradient(rgba(2, 2, 2, 0.71), rgba(31, 29, 29, 0.94)),background-repeat: no-repeat; background-size: cover  ">
			<tr>
				<td align="center" valign="top">
					<!-- FLEXIBLE CONTAINER // -->
					<!--
								...
								<table border="0" cellpadding="30" cellspacing="0" width="100%">
									<tr>
										<td valign="top" bgcolor="#E1E1E1">
											...
											<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
												<div>Copyright &#169; {{date('Y')}} <a href="https://traya.com.ar" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">Traya</span></a>. Todos &nbsp;derechos&nbsp;reservados.</div>
